...
part of 'filters_controllers.dart';
...
@ProviderFor(ShowDeletedFilter)
final showDeletedFilterProvider =
    AutoDisposeNotifierProvider<ShowDeletedFilter, bool>.internal(
  ShowDeletedFilter.new,
  name: r'showDeletedFilterProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$showDeletedFilterHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
